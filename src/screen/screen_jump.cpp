...
***********************************************************************/
void ach::ScreenJump::renderNetwork() {
...
***********************************************************************/
void ach::ScreenJump::renderNeuron(int x, int y, sf::Color c, int border, sf::Color bc) {
...
***********************************************************************/
void ach::ScreenJump::renderLine(int x1, int y1, int x2, int y2, float weight) {
...
***********************************************************************/
void ach::ScreenJump::renderText() {
...
***********************************************************************/
float ach::ScreenJump::fitness(ach::Color c1, ach::Color c2) {
...
***********************************************************************/
void ach::ScreenJump::process(unsigned int index) {
	iterations++;
...
***********************************************************************/
void ach::ScreenJump::copyColors() {
...
***********************************************************************/
void ach::ScreenJump::copyWeights() {
